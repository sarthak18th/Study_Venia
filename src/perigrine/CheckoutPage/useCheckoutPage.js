...
import { useGoogleReCaptcha } from '@magento/peregrine/lib/hooks/useGoogleReCaptcha/index';
...
import { SET_BILLING_ADDRESS,GET_ORDER_DETAILS } from './checkoutMutation';
import { PLACE_ORDER } from './checkoutMutation';
/**
 *
...
export const useCheckoutPage = (props = {}) => {
    ...
    const [setBillingAddress, { loading, error }] = useMutation(SET_BILLING_ADDRESS);
    // const [placeOrderMut, { loading, error }] = useMutation(PLACE_ORDER);
    ...
    variables: { cartId }
        ...
        //     variables: {
        //         cartId: cartId,
        //         firstName: data?.cart?.shipping_addresses[0]?.firstname,
        //         lastName: data?.cart?.shipping_addresses[0]?.lastname,
        //         street1: data?.cart?.shipping_addresses[0]?.street[0],
        //         street2:data?.cart?.shipping_addresses[0]?.street[1],
        //         city: data?.cart?.shipping_addresses[0]?.city,
        //         region: data?.cart?.shipping_addresses[0]?.region.label,
        //         postcode: data?.cart?.shipping_addresses[0]?.postcode,
        //         country: data?.cart?.shipping_addresses[0]?.country.label,
        //         phoneNumber: data?.cart?.shipping_addresses[0]?.telephone
        //     }
        // })
        // await placeOrderMut({
        //     variables:{
